...
class IOUContract : Contract {
    ...
    override fun verify(tx: LedgerTransaction) {
        ...
        requireThat {
            ...
            "Both lender and borrower together only may sign IOU issue transaction." using (tx.commands.requireSingleCommand(Commands.Issue::class.java).signers.toSet() == listOf(outputState.borrower.owningKey, outputState.lender.owningKey).toSet())
        }
    }
}